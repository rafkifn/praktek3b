...
<head>
    ...
    <link href="{{asset('style3/lib/animate/animate.min.css') }}" rel="stylesheet">
    <link href="{{asset('style3/lib/owlcarousel/assets/owl.carousel.min.css') }}" rel="stylesheet">

    <!-- Customized Bootstrap Stylesheet -->
    <link href="{{asset('style3/css/bootstrap.min.css') }}" rel="stylesheet">

    <!-- Template Stylesheet -->
    <link href="{{asset('style3/css/style.css') }}" rel="stylesheet">
</head>
    ...
    <div class="container-xxl bg-white p-0">
       ...
       <!--  <div id="spinner" class="show bg-white position-fixed translate-middle w-100 vh-100 top-50 start-50 d-flex align-items-center justify-content-center">
        ...
        <div class="col-md-6 d-flex">
            <form action="/bizz" method="GET" class="md-3">
                 @if (request(["judul_buku"]))
                    <input type="hidden" name="judul_buku" value="{{ request('judul_buku') }}">
                @endif
                @if (request(["sinopsis"]))
                    <input type="hidden" name="sinopsis" value="{{ request('sinopsis') }}">
                @endif
                ...
                <div class="input-group mb-3">
                    ...
                    <a href="{{route('login')}}" class="btn btn-light rounded-pill text-primary py-2 px-4 ms-lg-5">Login/Register</a>
                </div>
            </nav>
            ...
            <div class="container">
                <div class="mx-auto text-center wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;"> -->
                   <!--  <div class="d-inline-block border rounded-pill text-primary px-4 mb-3">Our Team</div> -->
                    <h2 class="mb-5">Buku Rekomendasi</h2>
                </div>
              <div class="col-xl-3 col-md-6 mb-4">
              <div class="card border-left shadow h-100 py-5">
                <div class="card-body">
...
{{$bukuu->sinopsis}}
                    ...
                    <div class="col-auto">
                       <a href="{{route('v_detail')}}"
                                                        class="text-left">Details</a>
                    </div>
                    @endforeach
                  </div>
                </div>
             ...
             <!--  </h5>
              <h5>
               <img class="img-fluid rounded-box w-50 mb-4" src="style3/img/team-1.jpg" alt="">
                <div class="d-flex justify-content-center">    
                    ...
                    <!-- <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="team-item"> -->
                            <!-- <h5>Full Name</h5>
                            <p class="mb-4">Designation</p> -->
                      <!--       <img class="img-fluid rounded-circle w-100 mb-4" src="style3/img/team-2.jpg" alt=""> -->
                          <!--   <div class="d-flex justify-content-center">
             ...
             <!--        <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                   ...
                   <!--  <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.7s">
                    ...
                    <div class="col-md-2 m-4">
                            <form>
                                <div class="card gq-box-produk">
                                    <center><img src="" width="100%"></center>
                                    <div class="card-body">
                                        <h5 class="ff-mns fw-b fs-18 lh-22 fc-blc mb-0"></h5>
                                        <div class="gq-harga">
                                            <span>Rp.</span>
                                            <br>
                                            <div class="row mt-2">
    ...
    <script src="{{asset('style3/lib/wow/wow.min.js') }}"></script>
    <script src="{{asset('style3/lib/easing/easing.min.js') }}"></script>
    <script src="{{asset('style3/lib/waypoints/waypoints.min.js') }}"></script>
    <script src="{{asset('style3/lib/owlcarousel/owl.carousel.min.js') }}"></script>
